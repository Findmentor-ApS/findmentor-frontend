...
const routes: Routes = [
  ...
  {path:'clients',pathMatch:'full', component:ClientsComponent, resolve: {user: ProfileResolver, clients: ClientsResolver},data: { allowedTypes: ['commune', 'mentor'] }, canActivate: [AuthGuard, TypeGuard]},
